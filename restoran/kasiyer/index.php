<?php
	...
	$veri=$restoraniskelet->sorgum2($db,"select * from kasiyer where durum=1",1)->num_rows;
?>
...
<body style="background-color:#e5e5e5">
  ...
  <div class="row table-dark" id="rows">
	<div class="col-md-4 border-right text-center" style="align:center;"><br>Kasiyer Adı : <a class="text-warning"><?php $restoraniskelet->garsonbak($db);?></a></div>				
	<div class="col-md-4 border-right text-center"><br>Tarih  : <a class="text-warning"><?php echo date("d.m.Y");?></a></div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-header text-center">
          <h4 class="modal-title">Kasiyer Girişi</h4>
        ...
        <div class="modal-body">
         ...
         <div class="row mx-auto text-center">
         		...
         		<div class="col-md-12">Kasiyer Ad</div>
        		 <div class="col-md-12"><select name="ad" class="form-control mt-2">
                  <option value="0">Seç</option>
				  
				  <?php
					
					$b=$restoraniskelet->sorgum2($db,"select * from kasiyer",1);
